      ...
      <div className={`p-2 md:p-10 `}>
        ...
        <section className="mb-8 bg-white/40 shadow-lg rounded-md  py-4 md:py-5 px-2 md:px-4">
          <div className="">
            ...
            <div className="space-y-2 flex flex-col ">
              <div className=" text-center  flex-col md:text-left flex md:flex-row md:justify-around items-center gap-4 flex-wrap">
                <img
                  src="easy-to-remember.webp"
                  alt=""
                  className="h-[250px] w-[250px] object-contain opacity-60 rounded-md flex-[1]"
                />
                <p className="text-xl flex-[1]">
                  <span className="font-bold text-2xl">
                    Personalized Smart Links
                  </span>
                  : Generate easy-to-remember links for your social profiles
                  using your username and platform names.
                </p>
              </div>

              <div className="text-center  flex-col-reverse md:text-left flex md:flex-row md:justify-around  items-center gap-4 flex-wrap">
                <p className="text-xl flex-[1] ">
                  <span className="font-bold">Centralized Link Management</span>
                  : Update your social profile links in one place, and the
                  change reflects everywhere.
                </p>
                <img
                  src="update.webp"
                  alt=""
                  className="h-[250px] w-[250px] object-contain opacity-60 rounded-lg flex-[1]"
                />
              </div>
              <div className="text-center  flex-col md:text-left flex md:flex-row md:justify-around items-center gap-4 flex-wrap">
                <img
                ...
                />
                <p className="text-xl flex-[1]">
                  <span className="font-bold">Click Tracking</span>: Keep track
                  of how many times your social profile links are clicked.
                </p>
              </div>
              <div className="text-center  flex-col-reverse md:text-left flex md:flex-row items-center gap-4 flex-wrap">
                <p className="text-xl flex-[1]">
                  <span className="font-bold">Easy to Setup</span>: No
                  complicated setup; just choose your username, add the
                  platform, and you're ready to go!
                </p>
                <img
                  src="easysetup.webp"
                  alt=""
        ...
        <section className="mb-12 bg-white/40 shadow-lg rounded-md  py-4 md:py-5 px-2 md:px-4">
          ...
          <div className="space-y-4">
            ...
            <p>
              A: Unfortunately, usernames cannot be changed once they are set.
              Choose your username carefully!
            </p>

            <p className="font-semibold">Q: How do I track my link clicks?</p>
            <p>
              A: Click tracking is available through your dashboard. You can
              view the number of clicks for each link, and advanced analytics
              will be added soon.
            </p>

            <p className="font-semibold">
              Q: Can I use custom platforms other than the popular ones
              (Instagram, LinkedIn, etc.)?
            </p>
            <p>
              A: Yes! You can add any platform as long as you provide the
              correct profile URL.
            </p>
          </div>
        </section>
