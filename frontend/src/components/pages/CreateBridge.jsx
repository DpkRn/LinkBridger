      ...
      <div className="relative z-10 py-8 md:py-12 px-4 sm:px-6 md:px-10 lg:px-12">
        ...
        >
          <motion.form
            ...
            className="bg-white/10 dark:bg-gray-900/50 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-6 md:p-10 lg:p-12 space-y-6 md:space-y-8"
          >
            {/* Header */}
            <motion.div
            ...
            >
              ...
              <div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
                  {isEditMode ? "Edit Bridge" : "Create Bridge"}
                </h1>
                <p className="text-gray-300 dark:text-gray-400 text-sm md:text-base mt-1">
            ...
            {isEditMode && (
              <motion.div
                ...
                className="bg-blue-500/20 dark:bg-blue-900/30 border border-blue-400/30 dark:border-blue-600/50 rounded-2xl p-4 flex items-center gap-3"
              >
                <FaCheckCircle className="text-blue-400 text-xl flex-shrink-0" />
                <div>
                  <p className="text-blue-300 dark:text-blue-200 font-semibold">Edit Mode Active</p>
                  <p className="text-blue-200/80 dark:text-blue-300/80 text-sm">Editing link ID: <span className="font-mono font-bold">{editLinkData?.id}</span></p>
                </div>
              </motion.div>
            )}
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              <label className="flex items-center gap-2 text-white dark:text-gray-200 font-semibold text-lg">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white/10 dark:bg-gray-800/50 border border-white/20 dark:border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed lowercase"
                  required
                />
              </div>
            ...
            >
              ...
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-blue-400 transition-colors z-10">
                ...
                <input
                  ...
                  disabled={showWarningModal || loading}
                  className="w-full pl-12 pr-4 py-4 bg-white/10 dark:bg-gray-800/50 border border-white/20 dark:border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  required
                />
              </div>
              <p className="text-xs text-gray-400 dark:text-gray-500">
            ...
            >
              ...
              {isEditMode && (
                <motion.button
                  ...
                  whileHover={{ scale: loading ? 1 : 1.05 }}
                  whileTap={{ scale: loading ? 1 : 0.95 }}
                  className="py-4 px-8 bg-white/10 dark:bg-gray-800/50 hover:bg-white/20 dark:hover:bg-gray-700/50 text-white font-bold rounded-xl border border-white/20 dark:border-gray-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  <FaTimes />
                  Cancel
                </motion.button>
              ...
              {showBridge && (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-white">Your Personalized Link:</h3>
                  </div>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 bg-white/5 dark:bg-gray-800/30 rounded-xl border border-white/10">
                    <span
                      ref={linkRef}
                      className="break-all font-mono text-base md:text-lg text-white dark:text-gray-200 flex-1"
                    >
        ...
        {showWarningModal && editLinkData && (
          ...
          >
            <motion.div
              ...
              className="bg-white/10 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl shadow-2xl max-w-md w-full p-6 md:p-8 border-2 border-yellow-400/50 dark:border-yellow-500/50 relative overflow-hidden"
            >
              {/* Gradient Background */}
              ...
              <div className="relative z-10">
                ...
                <div className="mb-6">
                  <p className="text-gray-200 dark:text-gray-300 mb-4 leading-relaxed">
                    Changing the platform from <span className="font-bold text-red-400">"{editLinkData.source}"</span> to <span className="font-bold text-green-400">"{platform.toLowerCase()}"</span> will make your old link invalid!
                  </p>
                  
                  <div className="bg-white/5 dark:bg-gray-800/30 rounded-2xl p-4 space-y-4 mb-4 border border-white/10">
                    <div>
                      <p className="text-sm font-semibold text-gray-300 dark:text-gray-400 mb-2 flex items-center gap-2">
                        <FaTimes className="text-red-400" />
                        Old Link (will become invalid):
                      </p>
                      <p className="text-sm font-mono text-red-400 break-all bg-red-500/10 p-3 rounded-lg border border-red-500/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-mono text-green-400 break-all bg-green-500/10 p-3 rounded-lg border border-green-500/20">
                  ...
                  <div className="bg-yellow-500/20 border border-yellow-400/30 rounded-xl p-4">
                    <p className="text-sm text-yellow-200 dark:text-yellow-300 flex items-start gap-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <motion.button
                    ...
                    whileHover={{ scale: loading ? 1 : 1.05 }}
                    whileTap={{ scale: loading ? 1 : 0.95 }}
                    className="flex-1 py-3 px-6 bg-white/10 dark:bg-gray-800/50 hover:bg-white/20 dark:hover:bg-gray-700/50 text-white font-semibold rounded-xl border border-white/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Cancel
                  </motion.button>
                  <motion.button
